                        ...
                        <div class="tpfooter__widget footer-col-4 mb-50">
                            ...
                            <div class="tpfooter__widget-newsletter">
                                <p>Subscribe to the Orfarm mailing list to receive updates <br> on new arrivals &
                                    other information.</p>
                                <form action="https://weblearnbd.net/tphtml/orfarm/index.html">
                                    <span><i><img src="{{url('')}}/assets/img/shape/message-1.svg" alt=""></i></span>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-7 col-sm-12">
                        <div class="tpfooter__copyright">
                            <span class="tpfooter__copyright-text">Copyright © <a href="#">ORFARM</a> all rights
                                reserved. Powered by <a href="#">ThemePure</a>.</span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-5 col-sm-12">
                        <div class="tpfooter__copyright-thumb text-end">
                            <img src="{{url('')}}/assets/img/shape/footer-payment.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
